...
uv pip install --python /tmp/lde-venv/bin/python /tmp/lde-dist/linux_diagnostic_engine-0.3.0-py3-none-any.whl
```
...
The public product version is `0.3.0`; `lde --version` prints
`Linux Diagnostic Engine 0.3.0`. Without `--output-dir`, reports are written
