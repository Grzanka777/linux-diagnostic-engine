...
uv pip install --python /tmp/lde-venv/bin/python /tmp/lde-dist/linux_diagnostic_engine-0.1.4-py3-none-any.whl
```
...
The public product version is `0.1.4`; `lde --version` prints
`Linux Diagnostic Engine 0.1.4`. Without `--output-dir`, reports are written
